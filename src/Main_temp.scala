...
object Main_temp {
  ...
  def b(): Unit = {
    ...
    val feudEX: feud = ("Top 5 Pets", List("Dog", "Cat", "Rat", "Fish", "Bird"))
    val feudList: List[feud] = List(feudEX)
    val itemEX: item = ("Cheese Cake", 39.99)
